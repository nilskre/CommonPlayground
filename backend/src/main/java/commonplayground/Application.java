...
public class Application{
    ...
    public CommandLineRunner demo(SessionRepository sessionRepository, UserRepository userRepository) {
        return (args) -> {
            sessionRepository.save(new Session("Card Game", "Card fun", "Doppelkopf", "Schlosspark", "22.11.2018", "12:00", 4, Long.parseLong("1"), "Card Game", "offline"));
            sessionRepository.save(new Session("Raid", "Raid together", "CS", "WWW", "12.12.2018", "16:00", 42, Long.parseLong("1"), "MMO-RPG", "online"));
