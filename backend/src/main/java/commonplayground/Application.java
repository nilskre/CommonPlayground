...
public class Application{
    ...
    public CommandLineRunner demo(SessionRepository sessionRepository, UserRepository userRepository) {
        return (args) -> {
            ...
            sessionRepository.save(new Session("Raid", "Raid together", "CS", "WWW", "12.12.2023", "16:00", 42, Long.parseLong("1")));
            sessionRepository.save(new Session("GW2", "World Boss Run", "Guild Wars 2", "Lionsarch", "12.12.2018", "15:00", 50, Long.parseLong("1")));
