...
public class TestData {
    ...
    private void fillSessionData(){
        Session testSession1 = new Session("Card Game", "Card fun", "Doppelkopf", "Schlosspark", "22-11-2024", "12:00", 4, Long.parseLong(String.valueOf(testUserID)), "genre", "offline");
        Session testSession2 = new Session("Card Game", "Card fun", "Doppelkopf", "Schlosspark", "22-11-2024", "12:00", 4, Long.parseLong(String.valueOf(testUserID)), "abcd", "offline");
        Session testSession3 = new Session("GW2 World Boss Run", "Tequatl->Behemoth->Destroyer", "Guild Wars 2", "Lionsarch", "12-12-2020", "15:00", 50, Long.parseLong(String.valueOf(testUserID)), "genre", "online");
